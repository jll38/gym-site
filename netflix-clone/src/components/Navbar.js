...
export function Navbar({}) {
  return <nav className="flex text-xs justify-between py-4 px-8 fixed w-full bg-gradient-to-t from-gray-900 to-black">
          <div className="flex">
            <div className="pr-4 py-2">
              <svg className="" xmlns="http://www.w3.org/2000/svg" width="75" height="15" viewBox="0 0 1024 276.742">
          ...
          <div className="flex gap-5">
            ...
            <div className="flex gap-2">
              <img src="/image/Netflix-avatar.png" className="w-[30px] h-[30px] rounded-md" alt="profile image"></img>
